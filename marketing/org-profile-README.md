...
| | What it is | Where |
|---|---|---|
| 🧪 **TestFly** | Zero-boilerplate Java framework — driver lifecycle, smart waits, retries, parallel, HTML reports, API testing, accessibility-first locators | [`testfly`](https://github.com/testfly/testfly) · [Maven Central](https://central.sonatype.com/artifact/io.github.hakanngul/testfly) |
