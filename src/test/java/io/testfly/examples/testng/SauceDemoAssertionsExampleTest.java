...
/**
 * Example demonstrating modern TestFly assertions against https://www.saucedemo.com.
 *
 * <p>Showcases:
 * <ul>
 ...
 *   <li>New matchers: {@code hasAttribute}, {@code hasCssValue}, {@code isFocused}</li>
 *   <li>Fluent soft assertions with {@code softAssert(locator)} and {@code .softly()}</li>
 * </ul>
 *
 * <p>Run with:
 * <pre>mvn test -Dtest=io.testfly.examples.testng.SauceDemoAssertionsExampleTest</pre>
 */
