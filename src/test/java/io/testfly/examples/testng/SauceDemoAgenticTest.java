 ...
 * <ul>
 * <li><b>Goal-Oriented Autonomous Actions:</b> {@code act("...")} compiles
 * intents to Selenium steps
 * and freezes them to {@code .testfly/action-cache.json} for instant
 * replay.</li>
 * <li><b>Semantic Assertions:</b> {@code assertWithAi("...")} and
 * {@code violatesAi("...")} evaluate
 * complex UI states using zero-shot LLM reasoning without 500ms polling
 * latency.</li>
 * <li><b>Dynamic Intent Locators:</b> {@code byIntent("...")} locates elements
 * using accessibility
 * semantics and LLM intent matching.</li>
 * <li><b>AI-Driven Self-Healing:</b> Selectors automatically heal when IDs or
 * classes change.</li>
 * </ul>
 *
 * <p>
...
public class SauceDemoAgenticTest extends BaseTest {
    ...
    public void autonomousECommerceFlow() {
        ...
        // First run compiles; subsequent runs execute frozen action plan with 0 ms AI
        // latency
        ...
        assertWithAi(
                "The user is logged in and products catalog is displayed with item prices and Add to Cart buttons");
    ...
    public void elementLevelSemanticAssertions() {
        ...
        assertThat(find(".login-box"))
                .satisfiesAi("Contains input fields for Username, Password, and a Login submit button");
