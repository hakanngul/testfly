...
public class TestClockTest {
    ...
    // ── TestFlyApi annotation presence ───────────────────────────────

    @Test
    public void testClock_hasTestFlyApiAnnotation() {
        io.testfly.api.TestFlyApi annotation =
            TestClock.class.getAnnotation(io.testfly.api.TestFlyApi.class);
        assertNotNull(annotation, "TestClock must be annotated with @TestFlyApi");
