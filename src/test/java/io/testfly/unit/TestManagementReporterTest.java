...
public class TestManagementReporterTest {
    ...
    public void testManagementConfig_defaults() {
        TestFlyConfig.TestManagement cfg = new TestFlyConfig.TestManagement();

        TestFlyConfig.TestManagement.TestRail tr = cfg.getTestrail();
        assertNotNull(tr);
        assertFalse(tr.isEnabled());
        assertEquals(tr.getRunName(), "TestFly Run");
        assertTrue(tr.isAutoCreateRun());
        assertEquals(tr.getRunId(), 0);

        TestFlyConfig.TestManagement.Xray xray = cfg.getXray();
        assertNotNull(xray);
    ...
    public void testRailConfig_settersAndGetters() {
        TestFlyConfig.TestManagement.TestRail tr = new TestFlyConfig.TestManagement.TestRail();
        tr.setEnabled(true);
    ...
    public void xrayConfig_cloudMode_settersAndGetters() {
        TestFlyConfig.TestManagement.Xray x = new TestFlyConfig.TestManagement.Xray();
        x.setEnabled(true);
        x.setMode("cloud");
        x.setClientId("cid");
    ...
    @Test
    public void testFlyConfig_testManagementGetterSetter() {
        TestFlyConfig cfg = new TestFlyConfig();
        TestFlyConfig.TestManagement tm = new TestFlyConfig.TestManagement();
