...
public class PerformanceTest {
    ...
    // ── TestFlyApi annotation ────────────────────────────────────────

    @Test
    public void performanceAssert_hasTestFlyApiAnnotation() {
        io.testfly.api.TestFlyApi ann =
            PerformanceAssert.class.getAnnotation(io.testfly.api.TestFlyApi.class);
        assertNotNull(ann);
        assertEquals(ann.since(), "2.4.0");
    }

    @Test
    public void performanceMetrics_hasTestFlyApiAnnotation() {
        io.testfly.api.TestFlyApi ann =
            PerformanceMetrics.class.getAnnotation(io.testfly.api.TestFlyApi.class);
        assertNotNull(ann);
        assertEquals(ann.since(), "2.4.0");
    }
