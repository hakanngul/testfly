...
import io.testfly.driver.BrowserStackProvider;
import io.testfly.driver.SauceLabsProvider;
...
public class CloudProviderTest {
    ...
    public void browserstack_configDefaults() {
        TestFlyConfig.Execution.BrowserStack cfg = new TestFlyConfig.Execution.BrowserStack();
    ...
    public void saucelabs_configDefaults() {
        TestFlyConfig.Execution.SauceLabs cfg = new TestFlyConfig.Execution.SauceLabs();
