...
public final class MailboxClient {
    ...
    private final TestFlyConfig.Email config;

    MailboxClient(EmailProvider provider, TestFlyConfig.Email config) {
    ...
    public static MailboxClient create() {
        TestFlyConfig.Email emailConfig = emailConfig();
