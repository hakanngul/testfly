...
public final class ClipboardHelper {
    ...
    public void write(String text) {
        ...
        js.executeScript("window.__testFlyClipboard = arguments[0];", text);
    ...
    public String read() {
        ...
        try {
            Object result = js.executeScript(
                    "return window.__testFlyClipboard || null;");
     ...
     */
    public void clear() {
        jsExecutor().executeScript("window.__testFlyClipboard = null;");
    }
