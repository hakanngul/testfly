...
/**
 * Registry of built-in and custom {@link DeviceProfile} presets for
 ...
 * <li>{@code iPad Pro 12} — 1024×1366, scale 2.0, not-mobile, Safari iPad
 * UA</li>
 * </ul>
 *
 * <p>
...
public final class DeviceProfiles {
    ...
    /**
     * Returns {@code true} if a profile with the given name exists
     * (case-insensitive).
     */
    ...
    /**
     * Registers a custom device profile under the given name (case-insensitive
     * key).
    ...
    /**
     * Returns an unmodifiable view of all registered profile names (normalised,
     * lower-case).
     */
