 ...
 * <pre>
 * // SPI — create:
 * // META-INF/services/io.testfly.precondition.BaseConditions
...
public final class PreConditionRegistry {
    ...
    public static synchronized void loadAll() {
        ...
        for (BaseConditions provider : loader) {
            ...
            System.out.println("[TestFly] PreCondition provider loaded: " + provider.getClass().getSimpleName());
        }
        loaded = true;
    }
    ...
    public static synchronized void register(BaseConditions provider) {
        providers.add(provider);
        System.out.println("[TestFly] PreCondition provider registered: " + provider.getClass().getSimpleName());
    }
