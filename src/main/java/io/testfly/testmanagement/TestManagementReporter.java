 ...
 * {@code testmanagement} in {@code testfly.yml}.
 *
...
public final class TestManagementReporter {
    ...
    public void onSuiteStart() {
        TestFlyConfig.TestManagement cfg = loadConfig();
        if (cfg == null) return;

        TestFlyConfig.TestManagement.TestRail trCfg = cfg.getTestrail();
        ...
        TestFlyConfig.TestManagement.Xray xCfg = cfg.getXray();
    ...
    private TestFlyConfig.TestManagement loadConfig() {
        try {
