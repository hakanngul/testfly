 ...
 * TestFlyDefaults.set("timeouts.explicit", 15);
 * TestFlyDefaults.set("execution.maxActiveSessions", 10);
 * </pre>
 *
...
public final class TestFlyDefaults {
     ...
     * {@link io.testfly.lifecycle.FrameworkBootstrap} after config is loaded.
     */
    public static void applyMissing(TestFlyConfig config) {
