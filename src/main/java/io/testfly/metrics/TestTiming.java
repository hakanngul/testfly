...
public class TestTiming {
    ...
    private io.testfly.performance.PerformanceMetrics performanceMetrics;
    ...
    public void addStep(io.testfly.steps.StepRecord step) { steps.add(step); }
    public void clearSteps() { steps.clear(); }
    public java.util.List<io.testfly.steps.StepRecord> getSteps() {
